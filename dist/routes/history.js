    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (error)
                    throw error;
                return [2 /*return*/, res.json({ success: true, analyses: data })];
            case 2:
                error_1 = _b.sent();
                console.error('History error:', error_1);
...
router.get('/single/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, data, error, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                if (error)
                    throw error;
                if (!data)
                    return [2 /*return*/, res.status(404).json({ error: 'Analysis not found' })];
                return [2 /*return*/, res.json({ success: true, analysis: data })];
            case 2:
                error_2 = _b.sent();
                console.error('Single analysis error:', error_2);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (error)
                    throw error;
                return [2 /*return*/, res.json({ success: true, message: 'Analysis deleted' })];
            case 2:
                error_3 = _a.sent();
                console.error('Delete error:', error_3);
